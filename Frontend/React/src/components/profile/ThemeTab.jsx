    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-right-4 duration-300">
      <div>
        <h2 className="text-xl font-bold text-white flex items-center gap-2">
          <Palette className="text-[var(--primary-color)]" /> Personalizza
          FranzPLAY
        </h2>
        <p className="text-sm text-zinc-500 mt-1">
          Scegli il colore principale dell'interfaccia. Le modifiche sono
      ...
      <div className="mt-8 p-4 bg-zinc-950 rounded-xl border border-zinc-800">
        <p className="text-xs text-zinc-500 mb-2 uppercase tracking-wider font-bold">
          Anteprima Live
        </p>
